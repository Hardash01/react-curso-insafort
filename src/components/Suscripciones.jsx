...
export function Suscripciones () {
    ...
    return (
        <div className="mx-auto max-w-screen-xl w-4/6 my-10">
                ...
                {suscripcionesData.map((subs, index) => (
                    <div key={subs.id} className={`${
                        ...
                        <div className="flex flex-wrap flex-col">
                            {index === 1 ? <p className="text-center text-sm bg-white p-1 rounded-lg border border-sky-600 shadow-md shadow-sky-300 uppercase font-bold">Mas Popular</p> : ''}
